...
For example, I run Python2.7 and the command I use is `python -m SimpleHTTPServer 8001`. Now I can go to `http://localhost:8001/index_old.html` to debug my app! Try making an `index_old.html` with anything in it and serve it on localhost before you continue.
